...
public class Question1184 {
    public static void main(String[] args) {
        ...
        int res = s.distanceBetweenBusStops(arr, 0, 1);
        System.out.println(res);

        arr = new int[]{1, 2, 3, 4};
        res = s.distanceBetweenBusStops(arr, 0, 2);
        System.out.println(res);

        arr = new int[]{1, 2, 3, 4};
        res = s.distanceBetweenBusStops(arr, 0, 3);
        System.out.println(res);

        arr = new int[]{7,10,1,12,11,14,5,0};
        res = s.distanceBetweenBusStops(arr, 7, 2);
        System.out.println(res);
    }
}
